...
@section('title', 'Update Kesehatan - Klinik Mediva')
@section('page-title', 'Update Kesehatan')
        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="alert alert-info" style="border-radius:12px;">
                    ...
                    <strong>Informasi:</strong> Lakukan update kesehatan secara rutin untuk membantu bidan memantau kondisi kehamilan Anda.
                </div>
                ...
                <form action="{{ route('pasien.health-updates.store') }}" method="POST">
                    ...
                    <!-- Informasi Dasar -->
                    <h6 class="fw-bold text-primary mb-3 mt-3"><i class="bi bi-calendar-check me-1"></i> Informasi Dasar</h6>
                    <div class="row">
                    ...
                    <!-- Tanda Vital -->
                    <h6 class="fw-bold text-primary mb-3 mt-4"><i class="bi bi-thermometer-half me-1"></i> Tanda Vital (Opsional)</h6>
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label fw-semibold">Tekanan Darah (Sistolik)</label>
                            <div class="input-group">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label fw-semibold">Tekanan Darah (Diastolik)</label>
                            <div class="input-group">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Keluhan yang Dirasakan</label>
                        <textarea name="keluhan" class="form-control" rows="2" placeholder="Jelaskan keluhan yang Anda rasakan...">{{ old('keluhan') }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Catatan Tambahan</label>
                        <textarea name="catatan_pasien" class="form-control" rows="2" placeholder="Catatan lain yang ingin disampaikan...">{{ old('catatan_pasien') }}</textarea>
                    </div>

                    <div class="d-flex justify-content-between mt-4">
                        <a href="{{ route('pasien.health-updates.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left me-1"></i> Batal</a>
                        <button type="submit" class="btn btn-danger"><i class="bi bi-check-lg me-1"></i> Simpan Update</button>
                    </div>
                </form>
            </div>
        </div>
